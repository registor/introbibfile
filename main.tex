  ...
  \begin{spacing}{1.5}
    ...
    \begin{center}
      ...
      \begin{annotatedFigure}
        ...
        \annotatedFigureBox{0.031,0.022}{0.995,0.68}{blue}
      \end{annotatedFigure}
    \end{center}
  \end{spacing}
\end{frame}
...
\begin{frame}[fragile]{文献管理软件}{Zotero}
  \begin{spacing}{1.5}
    ...
    \end{itemize}    
    \begin{center}
      \includegraphics[width=0.5\textwidth]{05zoterohomepage}
    \end{center}
  \end{spacing}
\end{frame}
...
\begin{frame}[fragile]{文献管理软件}{Zotero}
  \begin{spacing}{1.2}
    ...
    \end{itemize}    
    \begin{center}
      \includegraphics[width=0.53\textwidth]{05zoterocnki04}\\%\quad
      \includegraphics[width=0.53\textwidth]{05zoterocnki05}
    \end{center}
  \end{spacing}
\end{frame}
...
\begin{frame}[fragile]{文献管理软件}{NoteExpress}
  \begin{spacing}{1.2}
    ...
    \end{itemize}    
    \begin{center}
      \includegraphics[width=0.75\textwidth]{06noteexpress05}
    \end{center}
  \end{spacing}
\end{frame}
